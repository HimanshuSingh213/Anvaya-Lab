...
/* ─── GitHub SVG ──────────────────────────────────── */
const GitHubIcon = () => (
    <svg className="mr-2 h-4 w-4 shrink-0" fill="#ffffff" viewBox="0 -0.5 25 25" xmlns="http://www.w3.org/2000/svg">
...
/* ─── Google SVG ──────────────────────────────────── */
const GoogleIcon = () => (
    <svg className="mr-2 h-4 w-4 shrink-0" viewBox="-0.5 0 48 48" xmlns="http://www.w3.org/2000/svg" fill="none">
...
export function SignInPageContent() {
    ...
    /* Handle OAuth cancellation redirects from the middleware */
    useEffect(() => {
        ...
        if (flow === "signup") {
            ...
            router.replace(`/sign-up?error=${error}`);
            return;
        }
    ...
    return (
        <div className="min-h-screen flex bg-background select-none">
            ...
            >
                ...
                >
                    <Image src="/logo.png" width={36} height={36} alt="AnvayaLab logo" className="w-9 h-9 object-contain" />
                ...
                <div className="space-y-10">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-foreground leading-tight tracking-tight">
                            Welcome back.<br />
                            <span className="text-foreground-muted">Your workspace awaits.</span>
                        </h2>
                        <p className="text-foreground-disabled text-base leading-relaxed max-w-sm">
                            Pick up right where you left off. Your collections, history, and settings are all here.
                        </p>
                    </motion.div>
                ...
                <div
                    ...
                    style={{ background: "color-mix(in srgb, var(--color-brand-purple) 7%, transparent)" }}
                />
                <div
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                        ...
                                        <FormItem>
                                            <div className="flex items-center justify-between mb-1">
                                                ...
                                                <Link
                                                    ...
                                                    className="text-xs text-foreground-disabled hover:text-foreground-muted transition-colors underline-offset-4 hover:underline"
                                                >
                                                    Forgot password?
                                                </Link>
                                            </div>
                                            <FormControl>
                                                <div className="relative">
                                                    <Input
                                                        ...
                                                        className="h-10 bg-surface border-border text-foreground placeholder:text-border-active focus-visible:ring-0 focus-visible:border-border-active rounded-lg text-sm transition-colors pr-10"
                                                        {...field}
                                                    />
                                                    <button
                                                        type="button"
                                                        onClick={() => setShowPassword((v) => !v)}
                                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground-disabled hover:text-foreground-muted transition-colors"
                            ...
                            <motion.div variants={itemVariants} className="pt-2">
                                <Button
                                    ...
                                    className="w-full h-10 bg-foreground hover:bg-foreground-secondary text-background font-semibold rounded-lg text-sm transition-all group"
                                >
